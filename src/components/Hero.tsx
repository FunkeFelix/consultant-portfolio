      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 mb-6 shadow-lg">
            ...
            <span className="text-sm font-medium text-slate-700">Business + Tech = Exponential Impact</span>
          </div>
          
          {/* Main heading */}
          <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-6 leading-tight">
            Where Business Meets
            <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent"> Innovation</span>
          </h1>
          ...
          <p className="text-lg text-slate-600 mb-10 max-w-3xl mx-auto">
            I bridge the gap between business strategy and technical execution, transforming complex processes into intelligent, automated solutions that drive real results.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10 max-w-4xl mx-auto">
            <div className="flex flex-col items-center gap-3 bg-white/70 backdrop-blur-sm rounded-xl px-6 py-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-1">Business Foundation</h3>
                <p className="text-sm text-slate-600">BSc Business + Process Optimization</p>
              </div>
            </div>
            <div className="flex flex-col items-center gap-3 bg-white/70 backdrop-blur-sm rounded-xl px-6 py-4">
              <Code2 className="w-8 h-8 text-indigo-600" />
              <div>
                <h3 className="font-bold text-slate-900 mb-1">Technical Mastery</h3>
                <p className="text-sm text-slate-600">Fullstack Development Expertise</p>
              </div>
            </div>
            <div className="flex flex-col items-center gap-3 bg-white/70 backdrop-blur-sm rounded-xl px-6 py-4">
              <Brain className="w-8 h-8 text-purple-600" />
              <div>
                <h3 className="font-bold text-slate-900 mb-1">AI Integration</h3>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            <div className="flex items-center gap-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg px-4 py-2 border border-blue-200">
              ...
              <span className="text-slate-700 font-medium text-sm">ROI-Focused Solutions</span>
            </div>
            <div className="flex items-center gap-2 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg px-4 py-2 border border-indigo-200">
              ...
              <span className="text-slate-700 font-medium text-sm">Stakeholder Communication</span>
            </div>
            <div className="flex items-center gap-2 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg px-4 py-2 border border-purple-200">
              ...
              <span className="text-slate-700 font-medium text-sm">Process Transformation</span>
            </div>
          </div>
